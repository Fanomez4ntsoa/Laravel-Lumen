...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(\App\Contracts\Admin\UserServiceInterface::class, App\Services\Models\UserService::class);
        ...
        $this->app->bind(\App\Contracts\User\OnBoardingServiceInterface::class, App\Services\User\UserService::class);
